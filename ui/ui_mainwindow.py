...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon1 = QIcon()
        icon1.addFile(":/select/import-file.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon4 = QIcon()
        icon4.addFile(":/rhombus/rhombus.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.progressBarHashCaclulation.setObjectName("progressBarHashCaclulation")
        ...
        icon5 = QIcon()
        icon5.addFile(":/calculate/drawing-compass.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon6 = QIcon()
        icon6.addFile(":/check/magnifying-glass.png", QSize(), QIcon.Normal, QIcon.Off)
    ...
    def retranslateUi(self, MainWindow):
        MainWindow.setWindowTitle(QCoreApplication.translate("MainWindow", "Free Hash Checker", None))
        self.groupBoxHashCalculation.setTitle(QCoreApplication.translate("MainWindow", "Hash Calculation", None))
        self.labelFileExplore.setText("")
        self.lineEditFileExplore.setPlaceholderText(QCoreApplication.translate("MainWindow", "Select a file to begin", None))
        self.buttonSelectFile.setText(QCoreApplication.translate("MainWindow", "Select file", None))
        self.buttonClearHashBox.setText(QCoreApplication.translate("MainWindow", "Clear", None))
        self.lineEditHashBox.setText("")
        self.lineEditHashBox.setPlaceholderText(QCoreApplication.translate("MainWindow", "Hash will be displayed here", None))
        self.buttonCopyToClipboard.setText(QCoreApplication.translate("MainWindow", "Copy", None))
        self.comboBoxHashChoices.setItemText(0, QCoreApplication.translate("MainWindow", "MD5", None))
        self.comboBoxHashChoices.setItemText(1, QCoreApplication.translate("MainWindow", "SHA1", None))
        self.comboBoxHashChoices.setItemText(2, QCoreApplication.translate("MainWindow", "SHA224", None))
        self.comboBoxHashChoices.setItemText(3, QCoreApplication.translate("MainWindow", "SHA256", None))
        self.comboBoxHashChoices.setItemText(4, QCoreApplication.translate("MainWindow", "SHA384", None))
        self.comboBoxHashChoices.setItemText(5, QCoreApplication.translate("MainWindow", "SHA512", None))

        self.comboBoxHashChoices.setCurrentText(QCoreApplication.translate("MainWindow", "MD5", None))
        self.progressBarHashCaclulation.setFormat(QCoreApplication.translate("MainWindow", "%p%", None))
        self.buttonHashCalculate.setText(QCoreApplication.translate("MainWindow", "Calculate", None))
        self.groupBoxHashMatcher.setTitle(QCoreApplication.translate("MainWindow", "Hash Matcher", None))
        self.buttonClearCheckHashBox.setText(QCoreApplication.translate("MainWindow", "Clear", None))
        self.lineEditCheckHashBox.setPlaceholderText(QCoreApplication.translate("MainWindow", "Paste hash here", None))
        self.buttonCheckHash.setText(QCoreApplication.translate("MainWindow", "Check", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.MainTab), QCoreApplication.translate("MainWindow", "Home", None))
        self.developerName.setText(QCoreApplication.translate("MainWindow", "<html><head/><body><p><span\n"
"                                                                style=\" font-size:10pt; font-weight:600;\">Developer:</span>\n"
"                                                                Rizwan Hasan</span></p></body></html>\n"
"                                                            ", None))
        self.developerEmail.setText(QCoreApplication.translate("MainWindow", "<html><head/><body><p><span\n"
"                                                                style=\" font-size:10pt; font-weight:600;\">Email:\n"
"                                                                </span>rizwan.hasan486@gmail.com </p></body></html>\n"
"                                                            ", None))
        self.logoCreditName.setText(QCoreApplication.translate("MainWindow", "<html><head/><body><p><span\n"
"                                                                style=\" font-size:10pt; font-weight:600;\">Logo\n"
"                                                                credit: </span>Sakib Khan Inan </p></body></html>\n"
"                                                            ", None))
        self.logoCreditEmail.setText(QCoreApplication.translate("MainWindow", "<html><head/><body><p><span\n"
"                                                                style=\" font-size:10pt; font-weight:600;\">Email:\n"
"                                                                </span>sakib.khaninan@hotmail.com </p></body></html>\n"
"                                                            ", None))
        self.icons8Credit.setText(QCoreApplication.translate("MainWindow", "<html><head/><body><p><span\n"
"                                                                style=\" font-size:10pt; font-weight:600;\">Icons\n"
"                                                                credit: </span>Icons8</p></body></html>\n"
"                                                            ", None))
        self.hashCheckerHeader.setText("")
        self.groupBox_2.setTitle(QCoreApplication.translate("MainWindow", "GitHub", None))
        self.sourceCodeLink.setText(QCoreApplication.translate("MainWindow", "<html><head/><body><p\n"
"                                                                                    align=\"center\"><a\n"
"                                                                                    href=\"https://github.com/Rizwan-Hasan/Free-Hash-Checker\"><img\n"
"                                                                                    src=\":/github/github.png\"/></a></p></body></html>\n"
"                                                                                ", None))
        self.groupBox_4.setTitle(QCoreApplication.translate("MainWindow", "Version", None))
        self.applicationVersion.setText(QCoreApplication.translate("MainWindow", "<html><head/><body><p\n"
"                                                                                    align=\"center\"><span\n"
"                                                                                    style=\" font-size:22pt;\n"
"                                                                                    font-weight:600;\">0.0</span></p></body></html>\n"
"                                                                                ", None))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.AboutTab), QCoreApplication.translate("MainWindow", "About", None))
    # retranslateUi
